        ...
        for data in self.all_data:
            if not self.all_data[data]["analysed"]:
                ...
                if len(LowCapNew):
                    ...
                    implant_open, metal_open = self.find_metal_and_implant_open(LowCapNew, working_data, piecewiselms,
                                                   cutted_array, self.settings["LMSsize"],
                ...
                self.all_data[data]["Detailed_info"] = {"ImplantOpen": np.array(implant_open),
